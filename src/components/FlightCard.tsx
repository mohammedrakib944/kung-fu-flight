          ...
          <div className="space-y-10">
            ...
            {flight.itineraries.length > 1 && (
              <div className="pt-10 border-t border-white/5 relative">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-surface-50 border border-white/5 px-4 py-0.5 rounded-full text-[8px] font-semibold text-gray-500 uppercase tracking-[0.3em]">
                  Return Leg
                </div>
                <Itinerary itinerary={flight.itineraries[1]} label="Return" />
              </div>
            )}
          </div>
        </div>
