...
import { formatDuration, formatTime, formatDate } from '../../utils/flightUtils';
...
export const Itinerary: React.FC<ItineraryProps> = ({ itinerary, label }) => {
  ...
  return (
    <div className="relative">
      <div className="text-[10px] font-black text-primary-500 uppercase tracking-[0.2em] mb-4 bg-primary-500/5 w-fit px-2 py-0.5 rounded-md border border-primary-500/10 inline-block">
        {label}
      </div>
